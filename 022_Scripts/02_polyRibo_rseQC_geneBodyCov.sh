...
#BSUB -M 500M # Memory
#BSUB -R "select[mem>500M] rusage[mem=500M] span[hosts=1]"
#BSUB -n 1 # CPU's
#BSUB -q normal # Queue (n=normal, l=long)
#BSUB -J nv4geneBodCov
#BSUB -o /lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/Logs/02_polyRibo_rseQC_geneBodyCov_qNormal_m500M_n1.log
#BSUB -e /lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/Logs/02_polyRibo_rseQC_geneBodyCov_qNormal_m500M_n1.err

# run this from nv4/ --> bsub -G team267-grp < ./02_polyRibo/022_Scripts/02_polyRibo_rseQC_geneBodyCov.sh
...
RESDIR_RIBO="/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/test/02_polyRibo_rseQC_geneBodyCov_riboOutput/"
RESDIR_POLY="/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/test/02_polyRibo_rseQC_geneBodyCov_polyOutput/"
...
geneBody_coverage.py -i "/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/021_Data/fromKevin/test/rseQC/2169Ta.polya.bam" \
 -r $BED \
 -f pdf \
 -o "/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/test/02_polyRibo_rseQC_geneBodyCov_test/2169Ta.polya.bam"