...
#BSUB -J nv4tin
#BSUB -o /lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/Logs/02_polyRibo_rseQC_tin_qNormal_m3.5GB_n1.log
#BSUB -e /lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/Logs/02_polyRibo_rseQC_tin_qNormal_m3.5GB_n1.err

# run this from nv4/ --> bsub -G team267-grp < ./02_polyRibo/022_Scripts/02_polyRibo_rseQC_tin.sh
...
RESDIR_RIBO="/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/test/02_polyRibo_rseQC_tin_riboOutput/"
RESDIR_POLY="/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/test/02_polyRibo_rseQC_tin_polyOutput/"
...
# -s subtracts background noise, for high intronic reads. 
# tin results are save in wdir when running the script, so cd to results file first. 
tin.py -i "/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/021_Data/fromKevin/test/rseQC/2169Ta.polya.bam" \
 -r $BED > "/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/test/02_polyRibo_rseQC_tin_test/02_polyRibo_rseQC_tin_test_2169Ta.polya.bam_result.txt"

tin.py -i "/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/021_Data/fromKevin/test/rseQC/2169Ta.polya.bam" \
 -r $BED -s > "/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/test/02_polyRibo_rseQC_tin_test/02_polyRibo_rseQC_tin_test_2169Ta.polya.bam_result_s.txt"