...
#BSUB -J nv4rseqc
#BSUB -o /lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/Logs/02_polyRibo_rseQC_riboOutput_execute_qNormal_m1000_n4.log
#BSUB -e /lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/Logs/02_polyRibo_rseQC_riboOutput_execute_qNormal_m1000_n4.err

# run this from nv4/ --> bsub -G team267-grp < ./02_polyRibo/022_Scripts/02_polyRibo_rseQC_ribo_execute.sh
...
BAM_DIR_RIBO="/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/021_Data/bam/ribo/"

# Output file
OUT_CSV="/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/021_Data/bam/ribo/02_polyRibo_rseQC_riboOutput_bam.csv"

# # Write header
echo "bam" > "$OUT_CSV"

# # Find all .bam files in the folder and append to CSV
find "$BAM_DIR_RIBO" -type f -name "*.bam" | sort >> "$OUT_CSV"

# echo "Created $OUT_CSV with $(wc -l < $OUT_CSV) entries (including header)"

RSEQC_SCRIPT="/lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/022_Scripts/02_polyRibo_rseQC_ribo.sh"
