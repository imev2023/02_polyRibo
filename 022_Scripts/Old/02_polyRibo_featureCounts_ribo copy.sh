...
#BSUB -J nv4fCribo
#BSUB -o /lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/Logs/02_polyRibo_featureCounts_ribo_qLong_m3.5G_n4.log
#BSUB -e /lustre/scratch125/casm/staging/team267_murchison/nv4/02_polyRibo/023_Results/Logs/02_polyRibo_featureCounts_ribo_qLong_m3.5G_n4.err

# run this from nv4/ --> bsub -G team267-grp < ./02_polyRibo/022_Scripts/02_polyRibo_featureCounts_ribo.sh
...
do
    ...
    TEMP_NFSDIR_RIBO="$NFSDIR_RIBO/$riboName/"
    mkdir $TEMP_NFSDIR_RIBO
    ...
    cp -r $TEMP_RESDIR_RIBO/* $TEMP_NFSDIR_RIBO/
